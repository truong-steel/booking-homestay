...
import com.vti.hotelbooking.exception.InvalidBookingRequestException;
...
import com.vti.hotelbooking.repository.BookingRepository;
...
public class BookingServiceImpl implements BookingService {
    ...
    public List<BookedRoom> getBookingsByUserEmail(String email) {
        User thisUser = userService.getUser(email);
        return bookingRepository.findByUser(thisUser);
    }
